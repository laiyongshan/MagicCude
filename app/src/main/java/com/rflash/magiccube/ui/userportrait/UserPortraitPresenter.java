...
public class UserPortraitPresenter extends BasePresenterImpl<UserPortraitContract.View> implements UserPortraitContract.Presenter{

    @Override
    public void queryUserPortrait(String creditType, String pageNum) {
        String signature = "";
