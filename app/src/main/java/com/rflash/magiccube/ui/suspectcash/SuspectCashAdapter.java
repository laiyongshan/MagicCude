...
public class SuspectCashAdapter extends BaseAdp<CreditShareItem.ResultBean> {
    public SuspectCashAdapter(Context context, List<CreditShareItem.ResultBean> data, int layoutId) {
