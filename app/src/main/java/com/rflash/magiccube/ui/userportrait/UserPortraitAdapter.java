...
public class UserPortraitAdapter extends BaseAdp<CreditShareItem.ResultBean> {
    public UserPortraitAdapter(Context context, List<CreditShareItem.ResultBean> data, int layoutId) {
