...
public class CreditApplicationAdapter extends BaseAdp<CreditShareItem.ResultBean> {
    public CreditApplicationAdapter(Context context, List<CreditShareItem.ResultBean> data, int layoutId) {
