...
public class TransReportAdapter extends BaseAdp<CreditShareItem.ResultBean> {
    public TransReportAdapter(Context context, List<CreditShareItem.ResultBean> data, int layoutId) {
