...
public class UnOperationPresenter extends BasePresenterImpl<UnOperationContract.View> implements UnOperationContract.Presenter {

    private static final String TAG = "UnOperationPresenter";
    ...
    public void planQuery(String state, String tranType, String today, String pageNum,String cardNum) {
        ...
        String signature = "";
        String order = "p.plan_operator_time asc";
