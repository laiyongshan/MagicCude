...
public class CreditApplicationPresenter extends BasePresenterImpl<CreditApplicationContract.View> implements CreditApplicationContract.Presenter{

    @Override
    public void queryCreditApplication(String creditType, String pageNum) {
        String signature = "";
        ...
        try {
            ...
            compose.subscribe(new DefaultObserver<CreditShareItem>((BaseActivity) mView) {
                ...
                protected void onSuccess(CreditShareItem data) {
                    ...
                    mView.getCreditApplication(data);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
