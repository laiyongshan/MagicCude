...
public class BillCheckPresenter extends BasePresenterImpl<BillCheckContract.View> implements BillCheckContract.Presenter{

    @Override
    public void queryBillCheck(String creditType, String pageNum) {
        String signature = "";
