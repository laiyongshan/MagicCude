...
public class SuspectCashPresenter extends BasePresenterImpl<SuspectCashContract.View> implements SuspectCashContract.Presenter{

    @Override
    public void querySuspectCash(String creditType, String pageNum) {
        String signature = "";
