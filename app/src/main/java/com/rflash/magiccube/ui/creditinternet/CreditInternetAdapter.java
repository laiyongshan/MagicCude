...
public class CreditInternetAdapter extends BaseAdp<CreditShareItem.ResultBean> {
    public CreditInternetAdapter(Context context, List<CreditShareItem.ResultBean> data, int layoutId) {
