...
public class CreditInternetPresenter extends BasePresenterImpl<CreditInternetContract.View> implements CreditInternetContract.Presenter{

    @Override
    public void queryCreditInternet(String creditType, String pageNum) {
        String signature = "";
